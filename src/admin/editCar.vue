        ...
        <form @submit.prevent="updateCar" enctype="multipart/form-data">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" v-model="car.name" class="form-control" placeholder="e.g., Toyota Innova Crysta"
                required>
            </div>
          ...
          <div class="form-group">
            ...
            <textarea v-model="car.description" class="form-control" rows="3"
              placeholder="Add highlights: AC, Driver, luggage capacity, etc."></textarea>
          </div>
